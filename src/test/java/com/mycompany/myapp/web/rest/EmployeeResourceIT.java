...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).firstName(DEFAULT_FIRST_NAME).address(DEFAULT_ADDRESS);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS);
